...
@interface BrowserContentViewControllerObjCAdapter : WebContentController <AuthenticationSheetRequestDelegate, DimmingViewDelegate, ReaderActivationDelegate, ReaderAvailabilityDelegate, TabDialogPresenter, WBSFluidProgressStateSource>
{
