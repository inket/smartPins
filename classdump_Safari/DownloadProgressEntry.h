...
@class BrowserWindowController, DownloadFile, DownloadFileUnarchiver, NSArray, NSDate, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSProgress, NSString, NSTimer, NSURL, NSURLDownload, NSURLRequest, NSURLResponse;
